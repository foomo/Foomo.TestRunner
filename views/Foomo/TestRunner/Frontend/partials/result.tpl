...
?>
<div id="testRunnerUnitTestResult">
	<h2 class="<?= $css ?>"><?= $model->currentResult->name ?> <small>run <?= $result->count() . ' (' . round($result->time(), 4) . ')'; if($result->notImplementedCount() > 0): ?>, not implemented <?= $result->notImplementedCount();endif;  ?></small></h2>
